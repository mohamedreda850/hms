            ...
            <Grid size={{ lg: 5, md: 5, sm: 12, xs: 12 }}>
              <Box className="rate">
                ...
                <form onSubmit={handleRateSubmit(rateRoom)}>
                  ...
                  {userData ? <Button type='submit' sx={{ paddingInline: 8, marginTop: 3 }} variant="contained">Rate</Button> : <Button type='button' onClick={() => navigate('/auth/login')} sx={{ paddingInline: 8, marginTop: 3 }} variant="contained" >login</Button>}
                </form>
              </Box>
            </Grid>
            ...
            <Grid size={{ lg: 5, md: 5, sm: 12, xs: 12 }}>
              <Box className="comment">
                ...
                <form onSubmit={handleCommentSubmit(createComment)}>
                  ...
                  {userData ? <Button type='submit' sx={{ paddingInline: 8, marginTop: 5 }} variant="contained">Send</Button> : <Button type='button' onClick={() => navigate('/auth/login')} sx={{ paddingInline: 8, marginTop: 5 }} variant="contained" >login</Button>}
                </form>
              </Box>
            </Grid>
          </Grid>
